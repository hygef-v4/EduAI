...
1. **Law of Constitution**: You MUST read and follow [.sdd/constitution.md](file:///F:/code/git/EduAI/.sdd/constitution.md) on every task. No exceptions.
...
- **Technical Constitution**: [.sdd/constitution.md](file:///F:/code/git/EduAI/.sdd/constitution.md)
- **API Contracts**: [.sdd/shared_context.md](file:///F:/code/git/EduAI/.sdd/shared_context.md)
- **Business Rules**: [.sdd/constraints/business.md](file:///F:/code/git/EduAI/.sdd/constraints/business.md)
